...
const EXPLAIN_PREF_KEY = '@compscicarno_explain_pref';
...
const BOSS_CONFIG: Record<number, BossConfig> = {
  1: {
    ...
    accentColor:    '#f97316',
    taunts:         [
      "Your hardware knowledge is corrupted! 💾",
      "You couldn't even name a CPU component!",
      "My processor runs faster than your brain!",
      "Pathetic! You're no programmer!",
    ],
    timeoutTaunt:   "System timeout! No time left!",
    victoryMessage: "The Silicon Overlord is shut down!",
    defeatMessage:  "The Silicon Overlord overclocked you!",
  },
  2: {
    ...
    taunts:         [
      ...
      "My algorithms are smarter than your answers!",
      "Even a for-loop knows more than you!",
      "You'd be lost in an infinite loop!",
    ],
    timeoutTaunt:   "Stack overflow! No time left!",
    victoryMessage: "The Logic Beast is debugged!",
    defeatMessage:  "The Logic Beast crashed your program!",
  },
  3: {
    ...
    taunts:         [
      ...
      "Your bandwidth is lower than your score!",
      "A 404 error knows more than you!",
      "You're lost in the cloud!",
    ],
    timeoutTaunt:   "Connection dropped! No time left!",
    victoryMessage: "The Data Hydra is disconnected!",
    defeatMessage:  "The Data Hydra overwhelmed your network!",
  },
  4: {
    bgColors:       ['#3f2d00', '#1f1600'],
    accentColor:    '#eab308',
    taunts:         [
      "Even a chatbot outscores you! 🤖",
      "Your AI knowledge needs an upgrade!",
      "My neural networks are sharper than your mind!",
      "Even a decision tree has more answers than you!",
    ],
    timeoutTaunt:   "Processing failed — no time left!",
    victoryMessage: "The Neural Titan is deactivated!",
    defeatMessage:  "The Neural Titan overloaded you!",
  },
};
