/**
 * Final Boss — CompSciCarno
 *
 * The Supreme Algorithm: questions drawn from ALL 4 worlds combined.
...
const BOSS = {
  name:    'The Supreme Algorithm',
  icon:    '🤖',
  tagline: 'Knowledge from across the digital frontier',
};
    ...
    return (
      <SafeAreaView className="flex-1 bg-background items-center justify-center px-6">
        ...
        <Text className="text-2xl font-bold text-foreground mb-2 text-center">
          {defeated ? 'GAME COMPLETE!' : 'Crashed by the algorithm…'}
        </Text>
