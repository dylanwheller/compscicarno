...
export default function LoginScreen() {
  ...
  if (isLoading) {
    return (
      <View className="flex-1 bg-[#002622] items-center justify-center">
      ...
      <View className="flex-1 px-6 pt-16 pb-8">
        ...
        <View className="items-center mb-8">
          <Image
            ...
            resizeMode="cover"
          />
          <Text className="text-3xl font-bold text-[#99f6e4] text-center">
        ...
        {/* Form card */}
        <View className="rounded-2xl bg-[#003530] p-6 gap-3 shadow-lg">

          {/* Google sign-in */}
          <TouchableOpacity
            onPress={handleGoogleSignIn}
            disabled={submitting}
            className="flex-row items-center justify-center gap-3 rounded-xl bg-[#004a42] border border-[#00524a] px-4 py-3"
          >
          ...
          <View className="flex-row items-center gap-3 my-1">
            <View className="flex-1 h-px bg-[#00524a]" />
            <Text className="text-xs text-[#14b8a6]">or</Text>
            <View className="flex-1 h-px bg-[#00524a]" />
          </View>
          ...
          {mode === 'signup' && (
            <TextInput
              ...
              className="rounded-xl border border-[#00524a] bg-[#004a42] px-4 py-3 text-[#f0f9ff]"
          ...
          {/* Password */}
          <View className="flex-row items-center rounded-xl border border-[#00524a] bg-[#004a42]">
            <TextInput
              value={password}
          ...
          <TouchableOpacity
            ...
            disabled={submitting}
            className="rounded-xl bg-[#14b8a6] px-4 py-3 items-center mt-1"
          >
            {submitting ? (
          ...
          >
            <Text className="text-sm text-[#14b8a6]">
              {mode === 'signin'
        ...
        <Text className="text-center text-xs text-[#14b8a6]/60 mt-6">
          Version {version}
        </Text>
      </View>
    </KeyboardAvoidingView>
