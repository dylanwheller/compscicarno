...
const PLAY_STORE_URL = 'https://play.google.com/store/apps/details?id=com.smartypants.compscicarno';
...
export default function ProfileScreen() {
  ...
  const displayName = authUser?.displayName ?? localUser?.name ?? 'CompSciCarno Explorer';
            ...
            <View className="flex-row items-center gap-4">
              ...
              <View>
                ...
                {email
                  ...
                  : <Text className="text-primary font-medium text-sm">CompSciCarno Explorer</Text>}
            ...
            <View className="bg-card rounded-2xl p-4 border border-border">
              <View className="flex-row items-center gap-3">
                ...
                <View className="flex-1">
                  <Text className="text-foreground font-bold font-nunito">CompSciCarno Premium</Text>
