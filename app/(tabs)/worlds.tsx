          ...
          >
            ...
            >
              <View className="flex-1 p-5 justify-between">
                ...
                <View>
                  <Text style={{ color: '#fff', fontSize: 18, fontWeight: 'bold' }}>The Supreme Algorithm</Text>
                  <Text style={{ color: 'rgba(255,255,255,0.6)', fontSize: 12, marginTop: 2 }}>
                    {finalBossDefeated ? 'Defeated — you are a CompSciCarno Legend!' : 'All worlds combined · 1 000 XP'}
                  </Text>
                </View>
              </View>
            </View>
