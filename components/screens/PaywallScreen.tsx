/**
 * PaywallScreen — CompSciCarno
 *
 * Two-option paywall:
 *   1. CompSciCarno Only — R100 (smartypants_compscicarno)
...
const PLAY_STORE_URL =
  'https://play.google.com/store/apps/details?id=com.smartypants.compscicarno';

const APP_EMOJI = '🤖';
const APP_NAME  = 'CompSciCarno';
